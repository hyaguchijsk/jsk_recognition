...
add_library(parallel_saliency src/parallel_saliency.cpp)
add_library(opponent_color src/opponent_color.cpp)
add_executable(oriented_gradient_node src/oriented_gradient_node.cpp)
add_executable(parallel_saliency_node src/parallel_saliency_node.cpp)
...
target_link_libraries(oriented_gradient_node   ${catkin_LIBRARIES} ${OpenCV_LIBRARIES} ${Boost_LIBRARIES} oriented_gradient opponent_color)
target_link_libraries(parallel_saliency oriented_gradient)
target_link_libraries(parallel_saliency_node   ${catkin_LIBRARIES} ${OpenCV_LIBRARIES} ${Boost_LIBRARIES} parallel_saliency opponent_color)
